...
export const ACTIVITY_CONFIG = {
  ...
  fingerSequence: {
    easy: { count: 5, pool: 'easy' },
    medium: { count: 7, pool: 'medium' },
    hard: { count: 9, pool: 'hard' },
  },
  melodyKeys: {
    easy: { count: 5, pool: 'easy' },
    medium: { count: 7, pool: 'medium' },
  ...
  rhythmKeys: {
    easy: { count: 8, beatInterval: 1100, beatWindow: 400 },
    medium: { count: 12, beatInterval: 900, beatWindow: 350 },
    hard: { count: 16, beatInterval: 750, beatWindow: 300 },
  },
  fixAndType: {
    easy: { count: 5, pool: 'easy' },
    medium: { count: 7, pool: 'medium' },
  ...
  quickResponse: {
    easy: { count: 6, maxDelay: 1500 },
    medium: { count: 8, maxDelay: 1800 },
    hard: { count: 10, maxDelay: 2200 },
  },
  ergoCheck: {
    easy: { count: 4 },
    medium: { count: 6 },
  ...
  bimanualWords: {
    easy: { count: 5, pool: 'easy' },
    medium: { count: 7, pool: 'medium' },
    hard: { count: 6, pool: 'hard' },
  },
  thumbType: {
    easy: { count: 5, pool: 'easy' },
    medium: { count: 7, pool: 'medium' },
    hard: { count: 8, pool: 'hard' },
  },
  posturePause: {
    easy: { count: 3 },
    medium: { count: 5 },
  ...
  precisionPath: {
    easy: { count: 2, pool: 'easy', hitRadius: 32 },
    medium: { count: 3, pool: 'medium', hitRadius: 28 },
    hard: { count: 4, pool: 'hard', hitRadius: 24 },
  },
};
